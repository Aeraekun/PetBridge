...
import background from "assets/image/Mainslide2.jpg"
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: "rgba(255, 255, 255, 0.7)", // 배경색을 검은색 반투명으로 설정
        backgroundBlendMode: "overlay", // 이미지 위에 배경색이 오버레이되도록 설정
      }}
    >
